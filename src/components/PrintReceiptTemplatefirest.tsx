...
interface PrintReceiptTemplateProps {
  ...
  changeAmount: number;
  customerName?: string;
  customerPhone?: string; // تمت إضافة رقم هاتف العميل هنا
  cashierName: string;
  shopName?: string;
  phone?: string;
  logo?: string;
...
>((props, forwardedRef) => {
  ...
  // Theme color variables based on the image
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Meta Row (Date, Time) - تم إزالة رقم التذكرة */}
        ...
        {/* Cashier / Customer - تم تعديل طريقة العرض وإضافة الهاتف */}
            ...
            {safeItems.map((item, index) => (
              <React.Fragment key={index}>
                ...
                {/* {settings?.showDetails !== false && (item as any).imei1 && (
                  <tr>
                    <td colSpan={3} className="pt-0 pb-1.5 px-2.5 text-right text-[9px] opacity-80" dir="ltr">
