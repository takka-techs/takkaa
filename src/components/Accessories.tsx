...
import BulkEditAccessoriesModal from './BulkEditAccessoriesModal';
import AddMultipleAccessoriesModal from './AddMultipleAccessoriesModal';
        ...
        <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto justify-end">
          {selectedItems.length > 0 && (
            <button
              ...
              className="bg-purple-500/10 hover:bg-purple-500/20 text-purple-500 px-4 py-2.5 rounded-xl text-sm font-medium transition-colors flex items-center gap-2 border border-purple-500/20"
            >
              <Edit className="w-4 h-4" /> تعديل مجمع ({selectedItems.length})
            </button>
          )}
          <button
          ...
          <button
            ...
            className="bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-400 px-4 py-2.5 rounded-xl text-sm font-bold transition-colors flex items-center gap-2 border border-cyan-500/20"
          >
            <Layers className="w-4 h-4" /> إضافة متعددة
          </button>
          <button
