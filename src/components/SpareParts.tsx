...
//               className="bg-white dark:bg-[#11151c] border border-slate-200 dark:border-white/10 rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl"
//             >
//               {/* Modal Header */}
...
//               {/* Modal Body */}
//               <form onSubmit={handleEditPart} className="p-8 space-y-6">
...
//                   </div>
//                   <div className="space-y-1.5">
//                     <label className="text-xs font-bold text-slate-500 dark:text-slate-400 ms-1">سعر البيع (ج.م) <span className="text-red-500">*</span></label>
//                     <input 
//                       required
//                       type="number"
//                       min="0"
...
//               animate={{ opacity: 1, scale: 1, y: 0 }}
//               exit={{ opacity: 0, scale: 0.95, y: 20 }}
//               className="bg-white dark:bg-[#11151c] border border-slate-200 dark:border-white/10 rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl"
//             >
//               {/* Modal Header */}
//               <div className="px-8 py-6 border-b border-slate-200 dark:border-white/5 flex items-center justify-between bg-slate-50/50 dark:bg-white/5">
//                 <div className="flex items-center gap-3">
